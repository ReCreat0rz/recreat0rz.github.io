...
* Smart Contract
  A. Reentrancy Attack
	B. Understanding about EIP-7702
	C. How to compile solidity file
* Foundry
	A. Call Function
  B. Sign Transaction (Add the other's EOA to the player's EOA)
  C. Send Transaction (Register Gateway, Deposit Player's ETH Quota, and Deliver Gateway)
...
https://0x1uke.com/posts/HTBBusinessCTF2025BlockchainSpectralChallenge/#description
